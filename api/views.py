...
from .serializer import TrajectSerializer,UserSerializer,MatchSerializer,GuideSerializer
import json
...
"""),
    HumanMessage(content=f"By using the whole {structured_data} format it to json  . i will be there with {nombre} member,generate me some activities to do and food to eat to do in {ville1} from your knowledge .the objectif of this travel is {objectif} ")
]
...
{data}
"""),
    HumanMessage(content=f"give me a planning for activities i will spend {time} in {ville} i will be there with {number} member")
]
        response=chat(messages)
